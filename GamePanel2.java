...
public class GamePanel2 extends JPanel {
	...
	private String song = "/크로커다일.wav";
	private InfoPanel2 infoPanel2 = new InfoPanel2();
	private String id;

	public GamePanel2(JFrame jFrame, int heartNum, String id) {
		this.jFrame = jFrame;
	...
	private void splitPanel() {
		...
		vPane.setTopComponent(new MapPanel2());
		vPane.setBottomComponent(infoPanel2);
		...
		hPane.setLeftComponent(new GameGround2(jFrame, clip, heartNum, id));
