...
public class GamePanel4 extends JPanel {
	...
	private String song = "도플라밍고.wav";
	private InfoPanel4 infoPanel4 = new InfoPanel4();
	private String id;

	public GamePanel4(JFrame jFrame, int heartNum, String id) {
		this.jFrame = jFrame;
	...
	private void splitPanel() {
		...
		vPane.setTopComponent(new MapPanel4());
		vPane.setBottomComponent(infoPanel4);
		...
		hPane.setLeftComponent(new GameGround4(jFrame, clip, heartNum, id));
